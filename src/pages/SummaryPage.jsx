...
const TAKEAWAYS = [
  {
    ...
    body: 'Different ATS vendors, including Taleo, Workday, Greenhouse, and iCIMS, use proprietary algorithms that prioritize different signals. A 2021 Harvard Business School and Accenture study of more than 2,250 HR and business leaders found that 88% of employers acknowledge their own systems screen out qualified candidates, often because resumes are optimized for one platform\'s logic but not another\'s. This simulation reproduces that tension intentionally. The Keyword Match screener rewards keyword frequency while the Spam/Risk screener penalizes the same repetition as stuffing. The conflict between them is not a bug; it reflects how real hiring infrastructure operates.',
  ...
  },
  {
    ...
    body: 'A resume that passes ATS by loading keywords often fails with the human reviewer who reads it after. Gaming the algorithm gets you through the filter, but it does not get you the job. LinkedIn\'s Global Talent Trends research consistently finds that the competencies hiring managers rate as most valuable, such as communication, adaptability, and leadership, are the same ones a keyword list cannot demonstrate. Flooding a skills section signals optimization rather than capability, and recruiters are trained to recognize the difference.',
    citation: 'LinkedIn Global Talent Trends, 2023.',
  },
  {
    title: 'What ATS cannot measure',
    body: 'The same Harvard and Accenture study found that 88% of employers admit their ATS screens out qualified applicants before any human reviews them, and estimates suggest as many as 27 million workers in the United States are systematically excluded from hiring pipelines as a result. The filtering happens primarily on formatting requirements and credential proxies that have little relationship to actual job performance. The competencies employers consistently rate as most important, including leadership, adaptability, and communication, are exactly what keyword-matching algorithms cannot detect. These systems filter most aggressively on the dimensions that matter least.',
    citation: 'Fuller et al., "Hidden Workers: Untapped Talent," Harvard Business School / Accenture, 2021.',
  },
  {
    title: 'Who this system disadvantages',
    body: 'ATS systems do not create inequity from scratch; they amplify inequities that already exist in hiring. A landmark audit study from the National Bureau of Economic Research sent fictional resumes to over 100 large U.S. employers and found that candidates with distinctively Black names received callback rates 2.1 percentage points lower than identical resumes with white-associated names. ATS filters compound this disparity by removing candidates before any human judgment enters the process. Access to professional resume coaching, including knowledge of which formats, keywords, and conventions algorithms reward, is itself unequally distributed. Candidates without it are disproportionately excluded not because they are less qualified, but because they are less familiar with the rules they were never taught.',
